...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1334468187:AAEL_qxkapbXOaUdPkahSHVXMG_mymmoZiU")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1058640))
    API_HASH = os.environ.get("API_HASH", "20c76a0eb079ec6abe16b74474ba66d1")
    OWNER_ID = int(os.environ.get("OWNER_ID", 779289706))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001231300926").split())
